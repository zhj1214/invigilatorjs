      ...
      >
        <view
          ...
          :style="{
            ...
            flex: scroll ? '' : 1,
            border: hasBorder && current != i ? `1px solid ${pillsColor}` : '',
            borderRadius: pillsBorderRadius,
            padding: paddingItem,
            marginRight: `${marginItem}px`
          }"
          @click="change(i)"
        >
          {{ field ? v[field] : v }}
        ...
        <view
          ...
          :style="{
            ...
            borderRadius: pillsBorderRadius,
            left: `${pillsLeft + marginItem * current}px`, // 有margin值需要加上
...
export default {
  ...
  data() {
    return {
      elId: '',
      lineWidth: 30,
      currentWidth: 30, // 当前选项的宽度 先给一个初始宽度，否则页面加载有点突兀
